...
#if (DY_TARGET_PLATFORM == DY_PLATFORM_ANDROID)
...
//#define INCLUDE_SSE       : SSE code included
...
#if (DY_TARGET_PLATFORM == DY_PLATFORM_IOS)
    ...
    #else
    #endif
#elif (DY_TARGET_PLATFORM == DY_PLATFORM_ANDROID)
...
#ifdef USE_NEON32
    return true;
#elif (defined (INCLUDE_NEON32) && (DY_TARGET_PLATFORM == DY_PLATFORM_ANDROID) )
