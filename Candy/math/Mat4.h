...
public:
     ...
     */
    inline void transformPoint(Vec3* point) const { assert(point); transformVector(point->_x, point->_y, point->_z, 1.0f, point); }
     ...
     */
    inline void transformPoint(const Vec3& point, Vec3* dst) const { assert(dst); transformVector(point._x, point._y, point._z, 1.0f, dst); }
